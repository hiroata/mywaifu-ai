...
export function generateJapaneseWomen(count = 100) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    do {
      const familyName =
        japaneseFamilyNames[
          Math.floor(Math.random() * japaneseFamilyNames.length)
        ];
      const givenName =
        japaneseGivenNames[
          Math.floor(Math.random() * japaneseGivenNames.length)
        ];
    ...
    const taglineTemplate =
      taglineTemplates[Math.floor(Math.random() * taglineTemplates.length)];
    ...
    const popularity =
      popularities[Math.floor(Math.random() * popularities.length)];
