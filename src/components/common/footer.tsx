      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              あなただけのAIコンパニオンで、いつでもどこでも楽しい会話を。
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  href="mailto:support@mywaifuai.com"
                  className="text-gray-600 dark:text-gray-400 hover:text-accent dark:hover:text-accent transition-colors"
                >
                  お問い合わせ
                </a>
        ...
        <div className="border-t border-gray-100 dark:border-gray-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <select
              className="bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 py-1 px-2 rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-accent"
              defaultValue="ja"
            >
