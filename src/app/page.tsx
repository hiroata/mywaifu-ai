...
const animeCharacters = [
  {
    ...
    tagline: "バーチャルシンガー",
    avatarUrl:
      "https://images.unsplash.com/photo-1616766098946-e4fabb7d6da0?q=80&w=387&auto=format&fit=crop",
    isOnline: true,
    isNew: true,
    type: "アニメ",
    popularity: "人気",
  },
  {
    ...
    tagline: "魔法少女見習い中",
    avatarUrl:
      "https://images.unsplash.com/photo-1578632292335-df3abbb0d586?q=80&w=387&auto=format&fit=crop",
    isOnline: false,
    isNew: true,
    type: "アニメ",
    popularity: "新しい",
  },
  {
    ...
    tagline: "仮想世界の剣士",
    avatarUrl:
      "https://images.unsplash.com/photo-1617196701537-7329482cc9fe?q=80&w=387&auto=format&fit=crop",
    isOnline: true,
    isNew: false,
    type: "アニメ",
    popularity: "トレンド",
  },
  {
    ...
    avatarUrl:
      "https://images.unsplash.com/photo-1545439694-b4c0aa0a5e83?q=80&w=387&auto=format&fit=crop",
    isOnline: true,
    isNew: false,
    type: "アニメ",
    popularity: "人気",
  },
  {
    ...
    avatarUrl:
      "https://images.unsplash.com/photo-1638624269877-1f8b55da3e71?q=80&w=387&auto=format&fit=crop",
    isOnline: false,
    isNew: true,
    type: "アニメ",
    popularity: "新しい",
  },
  {
    ...
    tagline: "コーヒーが大好きです",
    avatarUrl:
      "https://images.unsplash.com/photo-1615631648086-325025c9e51e?q=80&w=387&auto=format&fit=crop",
    isOnline: true,
    isNew: false,
    type: "アニメ",
    popularity: "トレンド",
...
const maleCharacters = [
  ...
  },
  {
    ...
    tagline: "トレーニングが日課です",
    avatarUrl:
      "https://images.unsplash.com/photo-1517588632672-9758d6acba04?q=80&w=387&auto=format&fit=crop",
    isOnline: false,
    isNew: false,
    type: "実写",
    popularity: "人気",
  ...
  },
  {
    ...
    avatarUrl:
      "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=387&auto=format&fit=crop",
    isOnline: false,
    isNew: true,
    type: "リアル調",
    popularity: "新しい",
...
export default function HomePage() {
  ...
  const applyFilters = (characters: any[]) => {
    return characters.filter((character) => {
      // 年齢フィルター
      if (
        character.age < filters.ageRange[0] ||
        character.age > filters.ageRange[1]
      ) {
        return false;
      }
      ...
      if (
        ...
        !filters.characterTypes.includes(character.type)
      ) {
        return false;
      }
      ...
      // 人気度フィルター
      if (
        filters.popularity !== "すべて" &&
        character.popularity !== filters.popularity
      ) {
        return false;
      }
